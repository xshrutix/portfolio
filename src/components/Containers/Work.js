                    ...
                    <Box className="mx-8 md:ml-[350px] mt-12 mb-12 md:flex justify-center  ">
                        <ol className="relative border-l border-gray-200 dark:border-gray-700">
                            <li className="mb-10 ml-6">
                                ...
                                <time className="block mb-2 text-sm font-normal leading-none text-slate-5600 dark:text-slate-900">01/2024 - Present</time>
                                <p className="mb-4 text-base font-normal text-slate-900 dark:text-slate-900"><a aria-disabled
                                    className='text-gray-800' href='https://vmstechs.com' target='_blank' rel="noreferrer"> <b>VMS Tech</b> <PublicIcon /> </a><ul>
                                        <li>Designed and developed the website for IBS India.</li>
                                        <li>Designed and developed the vms tech website.</li>
                                        <li>Spearheaded the frontend development of VMS Events.</li>
                                        <li>Contributed to the development and implementation of WizSuite.</li>
                                        <li>Technology: Reacts.js, HTML, CSS(Tailwind, Bootstrap), JavaScript, Typescript.</li>
                                    </ul></p>
                            </li>
                            <li className="mb-10 ml-6">
                                <span className="flex absolute -left-3 justify-center items-center w-6 h-6 bg-orange-200 rounded-full ring-8 ring-white dark:ring-yellow-50 dark:bg-yellow-50">
